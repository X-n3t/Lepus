...
def init(domain):
	...
	if RIDDLER_USERNAME == "" or RIDDLER_PASSWORD == "":
		...
		headers = {"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.150 Safari/537.36", "content-type": "application/json"}
		...
		try:
			...
			if auth_response_json["meta"]["code"] == 200:
				...
				headers = {"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.150 Safari/537.36", "content-type": "application/json", "authentication-token": auth_token}
